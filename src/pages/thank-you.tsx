...
const BANK = {
  name: process.env.NEXT_PUBLIC_BANK_DEPOSIT_NAME || process.env.BANK_DEPOSIT_NAME || '',
  bsb: process.env.NEXT_PUBLIC_BANK_DEPOSIT_BSB || process.env.BANK_DEPOSIT_BSB || '',
  account: process.env.NEXT_PUBLIC_BANK_DEPOSIT_ACCOUNT || process.env.BANK_DEPOSIT_ACCOUNT || '',
  hint: process.env.NEXT_PUBLIC_BANK_DEPOSIT_REFERENCE_HINT || process.env.BANK_DEPOSIT_REFERENCE_HINT || '',
}
