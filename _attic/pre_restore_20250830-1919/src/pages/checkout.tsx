...
export default function CheckoutPage() {
  ...
  const remove =
    (cart as any)?.remove || (cart as any)?.removeItem || (() => {});
  const setQty =
    (cart as any)?.setQty || (cart as any)?.updateQty || (() => {});
  ...
  async function payWithPayPal() {
    ...
    try {
      ...
      const data = await res.json();
      if (!data?.approveUrl)
        throw new Error("PayPal response missing approveUrl");
          ...
          <>
            ...
            <section className="pay">
              ...
              <div className="actions">
                ...
                {payMethod === "bank" && (
                  <button onClick={bankDeposit} className="primary">
                    Show Bank Details
                  </button>
                )}
