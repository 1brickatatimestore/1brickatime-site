...
export default function CartPage() {
  ...
  const [placed, setPlaced] = useState<{ id: string; subtotal: number } | null>(
    null,
  );
      ...
      <main className="wrap">
          ...
          <div className="cart">
            {items.map((it) => (
              <div className="row" key={it.inventoryId}>
                ...
                <button className="rm" onClick={() => remove(it.inventoryId)}>
                  ×
                </button>
              </div>
            ))}
        ...
        {placed && (
          <div className="placed">
            <h2>Order Placed</h2>
            <p>
              <strong>Order ID:</strong> {placed.id}
            </p>
            <p>
              <strong>Amount:</strong> ${placed.subtotal.toFixed(2)}
            </p>
            <div className="bank">
