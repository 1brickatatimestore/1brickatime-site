      ...
      <main style={{ maxWidth: 900, margin: "0 auto", padding: 20 }}>
        ...
        {items.length === 0 ? (
          ...
          <>
                ...
                >
                  <div>
                    <div style={{ fontWeight: 700 }}>
                      {it.name || it.itemNo || "Minifig"}
                    </div>
                    <div style={{ fontSize: 13, color: "#555" }}>
                      {it.itemNo ? `SKU: ${it.itemNo}` : ""}{" "}
            ...
            <div style={{ fontSize: 18, fontWeight: 800, margin: "10px 0" }}>
            ...
            >
              ...
              >
                ...
                />
                <input
                  placeholder="Email (for invoice/details)"
                  value={email}
              ...
              {method === "bank" && (
                <p style={{ marginTop: 10, color: "#333" }}>
                  We’ll email bank details and hold items for 48 hours. Please
                  include your order ID in the transfer reference.
                </p>
              )}
            </fieldset>
